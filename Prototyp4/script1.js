document.addEventListener('DOMContentLoaded', () => {
    ...
    class Scene {
        constructor(description, choices, imageUrl) {
        ...
        display() {
            storyContainer.innerHTML = `
                <img src="${this.imageUrl}" alt="Scene Image">
    ...
    const scenes = {
        start: new Scene(
            `Durmstrang: Eine alte und geheimnisvolle Zauberschule, berühmt für ihre düstere Magie und strenge Disziplin. In dieser Festung des Wissens verborgen, leben Legenden über die Heiligen Relikte der Magie fort, drei Artefakte, deren Macht so groß ist, dass sie das Schicksal der magischen Welt verändern könnten. 
            
            Das Jahr 2024 bringt Unruhe in die magische Gemeinschaft: Nach Jahrhunderten des Vergessens wurden die Schattenstein, der Seelenspiegel und der Zeitweber wiederentdeckt. Diese Relikte haben das Potenzial, über Leben und Tod, Zeit und Raum zu herrschen.

            In dieser gefährlichen Zeit bist du, Lukas Roskow, ein Schüler von Durmstrang, von Träumen und Visionen geplagt. Du hast Visionen von den Relikten, dunklen Mächten und einem unausweichlichen Schicksal, das du erfüllen musst. 
            
            Gemeinsam mit deinem besten Freund Levi und anderen Verbündeten begibst du dich auf eine Reise, um die Relikte zu finden und zu verhindern, dass sie in die falschen Hände fallen.`,
            [
